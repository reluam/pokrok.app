...
Bez rychlé a přesné zpětné vazby se nelze zlepšit — opakuješ jen to, co už umíš, včetně chyb.

### EN

Without fast, accurate feedback you can't improve — you just repeat what you already do, mistakes and all.
...
Your performance grows when you know what you're doing wrong — and you know it right away. Feedback can come from outside (a coach, data) or from inside (a recording, a measurement, a timer). The shorter the loop between action and feedback, the faster you learn. That's why athletes record themselves, chess players analyze their games, and speakers review videos of their talks.

## Příklad ze života

Marek je prodejce. Roky dělal hovory a myslel si, že mu jde dobře. Pak začal každý hovor nahrávat a jednou týdně poslouchat s kolegou. Do měsíce si všiml, že skáče klientům do řeči a nereaguje na námitky. Uzavíraček vzrostlo o 40 % za tři měsíce.

### EN

Marek is a salesperson. For years he made calls and thought he was doing great. Then he started recording every call and listening to them once a week with a colleague. Within a month he noticed he was talking over clients and ignoring their objections. His close rate rose by 40 % in three months.

## Časté chyby

Lidé se zpětné vazbě vyhýbají, protože bolí. Další chyba je čekat na roční hodnocení místo okamžité reakce — v té době už jsi chybu zopakoval stokrát. A chyba je také přijímat jen pozitivní zpětnou vazbu a ignorovat kritiku.

### EN

People avoid feedback because it hurts. Another mistake is waiting for an annual review instead of immediate reactions — by then you've repeated the mistake a hundred times. And another mistake is accepting only positive feedback and ignoring criticism.
...
## Lekce 1 — Úvod
*id: `perf-l-pk-feedback-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, proč **bez zpětné vazby opakuješ stejné chyby roky** — a ani o tom nevíš. Projdeme si, jak funguje smyčka mezi akcí a zpětnou vazbou, proč je nahrávka silnější než intuice a jak si vytvořit zrcadlo pro svůj výkon.
...
In this lesson you'll understand why **without feedback you repeat the same mistakes for years** — and don't even know it. We'll go through how the loop between action and feedback works, why a recording is stronger than intuition, and how to create a mirror for your own performance.

### 2. Text

Představ si, že prodáváš deset let. Myslíš si, že jsi dobrý — nikdo ti neřekl opak. Pak začneš nahrávat své prodejní hovory a jednou týdně je poslouchat s kolegou.
...
Imagine you've been in sales for ten years. You think you're good — nobody told you otherwise. Then you start recording your sales calls and listening to them once a week with a colleague.
...
- ❌ Byl jsi líný se zlepšovat
  Nešlo o lenost, ale o nedostatek informací. S nahrávkou jsi okamžitě začal měnit chování — chybělo ti zrcadlo, ne motivace.
...
- ❌ You were too lazy to improve
  It wasn't laziness, it was a lack of information. Once you had the recording, you started changing behavior immediately — you were missing a mirror, not motivation.

### 4. Text

Za tři měsíce po začátku nahrávání a analýzy tvé uzavíračky vzrostou o 40 %. Chování se změní proto, že teď má **zrcadlo**.
...
Three months after you started recording and analyzing, your close rate rises by 40 %. Your behavior changes because it now has a **mirror**.
...
**Bez zpětné vazby opakuješ chyby, aniž bys to věděl.** Zrcadlo — nahrávka, data, kouč — je nezbytnost, ne luxus. Čím kratší smyčka mezi akcí a zpětnou vazbou, tím rychleji se učíš.

#### EN

**Without feedback you repeat mistakes without knowing it.** A mirror — recording, data, coach — is a necessity, not a luxury. The shorter the loop between action and feedback, the faster you learn.
...
- ❌ Nemají na to čas jindy
  Čas je vedlejší. Hlavní důvod je, že zpožděná zpětná vazba je méně účinná, protože paměť bledne.
...
- ❌ They don't have time for it later
  Time is secondary. The main reason is that delayed feedback is less effective because memory fades.
...
- ❌ Spoléhat se na pocit, jak ti to šlo
  Pocit je nespolehlivý. Deset let jsi prodával a myslel sis, že jsi dobrý — první nahrávka tě vyvedla z omylu.
...
- ❌ Rely on your gut feeling about how it went
  Gut feeling is unreliable. You sold for ten years and thought you were good — the first recording proved you wrong.

## Lekce 2 — Hluboký ponor
*id: `perf-l-pk-feedback-b` · typ: deep_dive · xp: 15*
...
V této lekci pochopíš, proč **rychlost zpětné vazby rozhoduje o rychlosti učení** — a proč roční hodnocení je téměř zbytečné. Projdeme si, jak funguje časová blízkost akce a důsledku, proč lidé ignorují zpětnou vazbu a jak překonat odpor k ní.
...
In this lesson you'll understand why **feedback speed determines learning speed** — and why annual reviews are nearly useless. We'll go through how temporal proximity of action and consequence works, why people ignore feedback, and how to overcome resistance to it.

### 2. Text

Představ si dva studenty, kteří se učí na zkoušku. První napíše test a výsledek zjistí za měsíc. Druhý po každé otázce okamžitě vidí, jestli odpověděl správně.
...
Imagine two students studying for an exam. The first one writes a test and finds out the result a month later. The second sees after each question whether they answered correctly.
...
Lidé se zpětné vazbě vyhýbají, protože **bolí**. Slyšet, co děláš špatně, je nepříjemné. Další chyba je přijímat jen pozitivní zpětnou vazbu a ignorovat kritiku — mozek to dělá přirozeně, protože chrání ego.

Ale bez nepříjemné zpětné vazby se nezlepšíš. Je to jako zrcadlo — nemusíš se rád dívat, ale bez něj nevíš, jak vypadáš.

#### EN

People avoid feedback because it **hurts**. Hearing what you're doing wrong is uncomfortable. Another mistake is accepting only positive feedback and ignoring criticism — the brain does this naturally because it protects the ego.
...
**Zkrať smyčku zpětné vazby na minimum** — ideálně v reálném čase nebo do několika minut. A překonávej odpor k nepříjemné zpětné vazbě — je to zrcadlo, které potřebuješ, i když se do něj nechceš dívat.

#### EN

**Shorten the feedback loop as much as possible** — ideally in real time or within a few minutes. And push through the resistance to uncomfortable feedback — it's a mirror you need, even when you don't want to look.
...
- ❌ Tvůj vlastní pocit, jak ti to šlo
  Pocit je nejnespolehlivější forma zpětné vazby. Deset let jsi prodával a myslel sis, že jsi dobrý — první nahrávka tě vyvedla z omylu.
...
- ❌ Your own feeling about how it went
  Feeling is the least reliable form of feedback. You sold for ten years and thought you were good — the first recording proved you wrong.
...
- ❌ Najít si trenéra
  Trenér je skvělý, ale ne vždy dostupný. Nahrávka nebo data ti dají zpětnou vazbu i bez trenéra.
...
- ❌ Find a coach
  A coach is great, but not always available. A recording or data gives you feedback even without a coach.

## Lekce 3 — Aplikace
*id: `perf-l-pk-feedback-c` · typ: application · xp: 15*

### 1. Úvod lekce

# Vytvoř si vlastní smyčku
*ikona: Activity*

V této lekci se naučíš **vytvořit si vlastní smyčku zpětné vazby** — i když nemáš trenéra, publikum ani kolegu. Uvidíš, že stačí nahrávka, deník nebo data, abys měl zrcadlo pro svůj výkon.
...
In this lesson you'll learn to **build your own feedback loop** — even without a coach, audience, or colleague. You'll see that a recording, journal, or data is enough to create a mirror for your performance.

### 2. Text

Představ si, že chceš být lepší řečník, ale vystoupení máš jen jednou za měsíc. Mezi tím nemáš žádnou zpětnou vazbu. Zlepšuješ se pomalu — máš jen 12 příležitostí ročně.
...
Imagine you want to become a better speaker, but you only get on stage once a month. Between talks you have no feedback at all. You improve slowly — just 12 opportunities a year.
...
Atul Gawande, chirurg a spisovatel, popsal ve své knize zážitek, kdy si po letech praxe najal kouče — jiného chirurga, který s ním na operačním sále sledoval jeho techniku. Poprvé za deset let dostal **zpětnou vazbu na proces**, ne jen na výsledky.
...
Atul Gawande, a surgeon and writer, described in his book the experience of hiring a coach after years of practice — another surgeon who watched his technique in the operating room. For the first time in ten years, he got **feedback on the process**, not just the results.
...
**Nemusíš čekat na „skutečné situace" pro zpětnou vazbu.** Vytvoř si vlastní smyčku — nahrávky, deník, data. A pokud můžeš, najdi si někoho, kdo ti dá externí pohled — i expert má slepá místa.

#### EN

**You don't have to wait for "real situations" to get feedback.** Build your own loop — recordings, a journal, data. And if you can, find someone who'll give you an outside perspective — even experts have blind spots.
...
- ❌ Počkáš, jestli ti někdo odpoví špatně
  To je příliš pozdě a příliš vágní. Potřebuješ aktivní analýzu, ne pasivní čekání na problémy.
...
- ❌ You wait to see if someone responds badly
  That's too late and too vague. You need active analysis, not passive waiting for problems.
...
- ❌ Ignorovat slepá místa — pokud jsi expert, nevadí
  I malá slepá místa se za roky naakumulují. Gawande byl expert a přesto ho kouč dramaticky posunul.
...
- ❌ Ignoring blind spots — if you're an expert, it doesn't matter
  Even small blind spots accumulate over the years. Gawande was an expert and still his coach moved him forward dramatically.
