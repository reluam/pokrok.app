...
Odpočinek není odměna po výkonu — je součástí výkonu. Bez regenerace klesá kvalita i u nejlepších.

### EN

Rest isn't a reward after performance — it's part of performance. Without recovery, quality drops even for the best.
...
Research on peak performance shows that top athletes and artists differ from average ones in how they rest too. Training load without recovery leads to overtraining, mistakes, and burnout. Sleep, passive rest, and breaks between intense blocks aren't lost time — they're the time when adaptation actually happens: muscles repair, memory consolidates, the nervous system resets.

## Příklad ze života

Anna trénuje triatlon a zpočátku tlačila každý den na maximum. Po třech měsících zhoršené časy, bolesti, únava. Trenér jí nastavil tvrdý trénink jen obden, mezi tím lehký běh a spánek 8 hodin. Za měsíc zlepšila osobní rekord o dvě minuty.

### EN

Anna trains for triathlon and at first she pushed to the max every day. After three months: worse times, pain, exhaustion. Her coach moved hard workouts to every other day, put easy runs in between, and made her sleep 8 hours. Within a month she'd beaten her personal best by two minutes.

## Časté chyby

Kultura hustle velebí „grind" a spánek jako slabost. Ve skutečnosti každý hodinový deficit spánku snižuje kognitivní výkon měřitelně. Další chyba: zaměňovat pasivní odpočinek (spánek, klid) s aktivní zábavou (scrollování telefonu), která nervový systém nezklidní.

### EN

Hustle culture worships the "grind" and treats sleep as weakness. In reality, every hour of sleep debt measurably lowers your cognitive performance. Another mistake: confusing passive rest (sleep, stillness) with active entertainment (scrolling your phone), which doesn't calm your nervous system down.
...
## Lekce 1 — Úvod
*id: `perf-l-pk-rest-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, proč **odpočinek není odměna po výkonu, ale jeho součást**. Projdeme si, co se děje v těle a mozku během regenerace, proč přetrénování vede ke stagnaci a proč špičkoví sportovci spí víc než průměrní.
...
In this lesson you'll understand why **rest isn't a reward after performance, but part of it**. We'll go through what happens in the body and brain during recovery, why overtraining leads to stagnation, and why top athletes sleep more than average ones.

### 2. Text

Představ si, že trénuješ na triatlon. První tři měsíce tlačíš každý den na maximum — běh, kolo, plavání, bez přestávky. Myslíš si, že víc tréninku = víc výsledků.
...
Imagine you're training for a triathlon. For the first three months you push to the max every day — running, cycling, swimming, no breaks. You think more training = more results.
...
- ❌ Nezmění se
  Změní se dramaticky. Regenerace je jeden z nejsilnějších nástrojů pro zlepšení výkonu.
...
- ❌ It won't change
  It will change dramatically. Recovery is one of the most powerful tools for boosting performance.

### 4. Text

Za měsíc zlepšíš osobní rekord o dvě minuty. Trénuješ méně, ale lépe. Odpočinek nebyl „lenost" — byl to **aktivní proces**, během kterého se svaly opravují, paměť konsoliduje a nervový systém obnovuje.
...
Within a month you beat your personal best by two minutes. You trained less, but better. Rest wasn't "laziness" — it was an **active process** during which muscles repair, memory consolidates, and the nervous system resets.
...
**Odpočinek není opakem výkonu — je jeho součástí.** Bez regenerace tělo a mozek nedokážou růst. Trénink je stimul, odpočinek je čas, kdy se skutečně děje adaptace.

#### EN

**Rest isn't the opposite of performance — it's part of it.** Without recovery, body and brain can't grow. Training is the stimulus, rest is when adaptation actually happens.
...
- ❌ Jsou líní
  Líný člověk se nedostane na špičku. Špičkoví sportovci spí víc, protože vědí, že bez regenerace nemůžou podávat výkon.
...
- ❌ They're lazy
  A lazy person doesn't reach the top. Top athletes sleep more because they know that without recovery they can't perform.

## Lekce 2 — Hluboký ponor
*id: `perf-l-pk-rest-b` · typ: deep_dive · xp: 15*
...
V této lekci pochopíš, proč **spánek je nejsilnější nástroj pro zlepšení výkonu** — silnější než jakýkoliv doplněk stravy nebo technika. Projdeme si, co se děje v mozku během spánku, proč noční učení nefunguje a jak spánkový dluh ničí výkon, aniž bys to věděl.
...
In this lesson you'll understand why **sleep is the most powerful tool for improving performance** — more powerful than any supplement or technique. We'll go through what happens in the brain during sleep, why cramming all night doesn't work, and how sleep debt destroys performance without you knowing it.

### 2. Text

Výzkumy spánku ukazují, že i **hodinový deficit spánku snižuje kognitivní výkon měřitelně**. Po dvou týdnech spaní 6 hodin místo 8 jsou lidé na úrovni toho, kdo byl 48 hodin vzhůru.
...
Sleep research shows that even **an hour of sleep debt measurably lowers your cognitive performance**. After two weeks of sleeping 6 hours instead of 8, people perform at the level of someone who's been awake for 48 hours.
...
Ericsson ve svém výzkumu zjistil, že špičkoví houslisté spali o **2 hodiny denně víc** než průměrní. A ještě si dělali krátké odpolední šlofíky. Nebyli líní — byli **strategičtí**.

Spánek pro ně nebyl čas ztracený tréninku. Byl to čas, kdy se dovednosti naučené během dne skutečně upevňovaly v mozku.

#### EN

In his research, Ericsson found that top violinists slept about **2 hours a day more** than average ones. And they took short afternoon naps on top of that. They weren't lazy — they were **strategic**.
...
**Spánek je nejlevnější a nejsilnější nástroj pro zlepšení výkonu.** Žádný doplněk stravy ani technika se mu nevyrovná. Během spánku se konsoliduje paměť, opravují svaly a obnovuje nervový systém.

#### EN

**Sleep is the cheapest and most powerful tool for improving performance.** No supplement or technique matches it. During sleep, memory consolidates, muscles repair, and the nervous system resets.
...
- ❌ Pít kávu a učit se přes noc
  Káva oddaluje únavu, ale nenahrazuje spánek. Bez konsolidace ve spánku se informace neuloží do dlouhodobé paměti.
...
- ❌ Drink coffee and study through the night
  Coffee delays fatigue but doesn't replace sleep. Without consolidation during sleep, information won't be stored in long-term memory.
...
- ❌ Nebude žádný rozdíl
  Rozdíl bude dramatický. Spánkový dluh z dvou let se sice nezaplatí za dva týdny, ale i částečné zlepšení spánku přinese měřitelný rozdíl.
...
- ❌ There won't be any difference
  The difference will be dramatic. Sleep debt from two years won't be paid off in two weeks, but even partial improvement in sleep will bring a measurable difference.

## Lekce 3 — Aplikace
*id: `perf-l-pk-rest-c` · typ: application · xp: 20*

### 1. Úvod lekce

# Spánek jako strategie
*ikona: Moon*

V této lekci se naučíš **zacházet se spánkem jako se strategickým nástrojem** — ne jako s něčím, co obětovat pro víc práce. Uvidíš konkrétní příklady z vrcholového sportu a managementu, které ukazují, že ti, kdo spí víc, vyhrávají.
...
In this lesson you'll learn to **treat sleep as a strategic tool** — not as something to sacrifice for more work. You'll see concrete examples from elite sports and management showing that those who sleep more, win.

### 2. Text

Roger Federer, jeden z nejúspěšnějších tenistů historie, v rozhovorech pravidelně zmiňoval, že spí **11–12 hodin denně**. Jeho trenér říká, že „regenerace je polovina naší práce".
...
Roger Federer, one of the most successful tennis players in history, regularly mentioned in interviews that he sleeps **11–12 hours a day**. His coach says, "Recovery is half of our work."
...
Představ si, že jsi manažer a pyšníš se tím, že spíš 5 hodin a pracuješ 14 hodin denně. Za dva roky: chronická únava, chyby v rozhodnutích, podrážděnost. Rozhodneš se experimentovat — dva týdny spíš 8 hodin místo 5.
...
Imagine you're a manager who prides himself on sleeping 5 hours and working 14 hours a day. Two years in: chronic fatigue, decision errors, a short fuse. You decide to experiment — for two weeks you sleep 8 hours instead of 5.
...
**Spánek není slabost. Je to strategický nástroj**, který ti dává nespravedlivou výhodu nad těmi, kdo spí málo. Mezi tebou a tvým potenciálem výkonu často stojí jen pár hodin spánku navíc.

#### EN

**Sleep isn't weakness. It's a strategic tool** that gives you an unfair advantage over people who skimp on it. The thing between you and your performance potential is often just a few more hours of sleep.
...
- ❌ Budeš pracovat víc hodin
  Víc hodin = víc únavy = horší kvalita. Začni opačně: víc spánku, méně hodin, lepší výsledky.
...
- ❌ Work more hours
  More hours = more fatigue = worse quality. Start the opposite way: more sleep, fewer hours, better results.
...
- ❌ Brát prášky na spaní
  Prášky mohou pomoci krátkodobě, ale nevytvářejí kvalitní spánek. Řešení je v návycích, ne v lécích.
