...
Jak k sobě mluvíš před výkonem a během něj přímo ovlivňuje, jak dobře ho podáš.

### EN

How you talk to yourself before and during a performance directly affects how well you do.
...
Research shows that your inner dialogue measurably affects your performance. Negative self-talk ("I'm definitely going to mess this up") raises stress, narrows attention, and hurts coordination. Positive instructional self-talk ("breathe, watch the ball, push through") focuses your attention and calms you down. The most effective form is "distanced self-talk" — talking to yourself in the second person or by name: "You've got this, Adéla." This creates distance between your brain and your emotions, so you think more rationally.

## Příklad ze života

Petra se před prezentacemi opakovala „nesmím se ztrapnit". Výsledek: třesoucí se hlas, zapomínání. Po konzultaci s koučem začala používat instruktivní self-talk: „Dýchej, podívej se na publikum, mluv pomalu." Za dva měsíce se její prezentace zásadně zlepšily.

### EN

Petra used to tell herself "I mustn't embarrass myself" before every talk. Result: shaky voice, forgetting lines. After working with a coach, she switched to instructional self-talk: "Breathe, look at the audience, speak slowly." Within two months her talks had transformed.

## Časté chyby

Lidé si myslí, že „pozitivní myšlení" znamená říkat si „jsem nejlepší". To nefunguje, když to neodpovídá realitě — mozek to odmítne. Účinnější je instruktivní self-talk zaměřený na proces, ne na výsledek.

### EN

People think "positive thinking" means telling yourself "I'm the best." That doesn't work when it doesn't match reality — your brain rejects it. Instructional self-talk focused on the process, not the outcome, is more effective.

---

# Lekce

## Lekce 1 — Slova v hlavě mění výkon
*id: `perf-l-mn-selftalk-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, jak **slova, která si říkáš v hlavě**, přímo ovlivňují tvůj výkon. Projdeme si rozdíl mezi negativním a instruktivním self-talkem a proč změna formulace mění výsledek.
...
In this lesson you'll understand how the **words you say to yourself in your head** directly affect your performance. We'll go through the difference between negative and instructional self-talk and why changing the phrasing changes the result.

### 2. Text

Představ si, že stojíš před důležitou prezentací. V hlavě ti zní: „Nesmím se ztrapnit, nesmím zakoktat." Výsledek? Třesoucí se hlas, zapomínání. Tvůj vnitřní dialog tě sabotuje. Výzkumy ukazují, že negativní self-talk („určitě to zkazím") zvyšuje stres, zužuje pozornost a zhoršuje koordinaci.
...
- ❌ Je to jen psychologie, reálně to výkon neovlivní
  Je to psychologie s měřitelnými výsledky. Výkon se mění objektivně, ne jen subjektivně.
...
- ❌ It's just psychology, it doesn't really affect performance
  It is psychology, but with measurable results. Performance changes objectively, not just subjectively.

### 4. Text

Když změníš slova v hlavě, změní se tvůj výkon. Ne proto, že bys přestal být nervózní — ale protože máš v hlavě **správná slova** místo strašidelných. Nervozita zůstane, ale místo paralýzy máš akční plán.

#### EN

When you change the words in your head, your performance changes. Not because you stop being nervous — but because you have the **right words** in your head instead of scary ones. The nerves stay, but instead of paralysis, you have an action plan.

### 5. Klíčový poznatek

Jak k sobě mluvíš, tak se chováš. Změň slova — změníš výkon.

#### EN

How you talk to yourself is how you act. Change the words — you change your performance.
...
**Otázka:** Který z těchto self-talků je nejúčinnější při nervozitě před výkonem?

- **✅ „Dýchej. Podívej se na publikum. Mluv pomalu."**
  Přesně. Krátké, konkrétní instrukce zaměřené na proces. Mozek dostane jasný akční plán místo vágních přání.
- ❌ „Jsem skvělý, všechno bude v pohodě."
  Afirmace nefungují, když jim nevěříš. Mozek je odmítne jako nepravdu a stres zůstane.
- ❌ „Nesmím být nervózní, musím se uklidnit."
  Negace plus nerealistický požadavek. Nervozita je přirozená a snažit se ji potlačit ji zesiluje.

#### EN

**Question:** Which self-talk is most effective when you're nervous before a performance?

- **✅ "Breathe. Look at the audience. Speak slowly."**
  Exactly. Short, concrete instructions focused on the process. The brain gets a clear action plan instead of vague wishes.
- ❌ "I'm great, everything will be fine."
  Affirmations don't work when you don't believe them. The brain rejects them as untrue and the stress remains.
- ❌ "I mustn't be nervous, I must calm down."
  A negation plus an unrealistic demand. Nerves are natural and trying to suppress them makes them stronger.
...
- ❌ Potlačit všechny negativní myšlenky
  Potlačování nefunguje — myšlenky se vrátí silnější. Cílem je nahradit negace instrukcemi, ne je potlačit.
...
- ❌ Suppress all negative thoughts
  Suppression doesn't work — the thoughts come back stronger. The goal is to replace negations with instructions, not to suppress them.

## Lekce 2 — Distanced self-talk
*id: `perf-l-mn-selftalk-b` · typ: deep_dive · xp: 15*

### 1. Úvod lekce

# Mluv k sobě ve druhé osobě
*ikona: Brain*

V této lekci pochopíš techniku **distanced self-talk** — proč je účinnější mluvit k sobě ve druhé osobě nebo vlastním jménem než v první osobě. Projdeme si výzkum psychologa Ethana Krosse a praktické důsledky.
...
In this lesson you'll understand the technique of **distanced self-talk** — why it's more effective to talk to yourself in the second person or by name than in the first person. We'll go through psychologist Ethan Kross's research and practical implications.

### 2. Text

Psycholog Ethan Kross zkoumal zajímavou věc: rozdíl mezi mluvením k sobě v první osobě („zvládnu to") a ve druhé osobě nebo vlastním jménem („Ty to zvládneš"). Výsledky ukázaly, že **distanced self-talk** — oslovování sebe jménem — snižuje stres a zlepšuje výkon výrazněji než první osoba.

#### EN

Psychologist Ethan Kross studied something interesting: the difference between talking to yourself in the first person ("I can do this") and in the second person or by name ("You've got this"). The results showed that **distanced self-talk** — addressing yourself by name — lowers stress and improves performance more than the first person.
...
Praktický dopad: když jsi ve stresu, zkus se oslovit vlastním jménem. „Dýchej. Pamatuj si, co máš dělat." Mozek zareaguje jinak než na „musím dýchat". Vytvoříš si odstup, který ti umožní myslet jasněji — jako by ses radil sám sobě z vnějšku.

#### EN

Practical implication: when you're stressed, try addressing yourself by name. "Breathe. Remember what you're here to do." Your brain reacts differently than to "I need to breathe." You create a distance that allows you to think more clearly — as if advising yourself from the outside.

### 5. Klíčový poznatek

Mluv k sobě jako ke kamarádovi — ve druhé osobě nebo vlastním jménem. Tvůj mozek tě pak bude poslouchat racionálněji.

#### EN

Talk to yourself the way you'd talk to a friend — in the second person or by name. Your brain will listen more rationally.
...
- ❌ „Jsem profík, tohle zvládnu levou zadní."
  Afirmace, které neodpovídají realitě, mozek odmítne. Pokud cítíš paniku, „levou zadní" tvůj mozek nepřijme.
...
- ❌ "I'm a pro, I'll handle this with ease."
  Affirmations that don't match reality get rejected by the brain. If you're feeling panicked, "with ease" won't be accepted.
...
## Lekce 3 — Self-talk v akci
*id: `perf-l-mn-selftalk-c` · typ: application · xp: 15*
...
V této lekci si vyzkoušíš, jak **přeformulovat negativní self-talk** na instruktivní v konkrétních situacích. Naučíš se všimnout si svých slov a změnit je.
...
In this lesson you'll practice **reframing negative self-talk** into instructional form in concrete situations. You'll learn to notice your words and change them.

### 2. Text

Představ si, že hraješ důležitý zápas. Třesou se ti ruce a děláš chyby. Zastavíš se a posloucháš svůj vnitřní hlas. Slyšíš: „Nesmím ten míč pokazit, nesmím prohrát." Každá věta obsahuje negaci. Tvůj mozek kreslí přesně to, čemu se chceš vyhnout.

#### EN

Imagine you're playing an important match. Your hands are shaking and you're making mistakes. You pause and listen to your inner voice. You hear: "I mustn't miss this ball, I mustn't lose." Every sentence is a negation. Your brain is painting exactly what you're trying to avoid.
...
Napíšeš si tři instrukce, které si budeš opakovat před každým klíčovým momentem: „Dýchej. Sleduj míč. Tlač skrz." Za měsíc pravidelného používání se tvůj výkon pod tlakem výrazně zlepší. Ne proto, že bys přestal být nervózní — ale protože máš **systém** místo chaosu.

#### EN

You write down three instructions you'll repeat before every key moment: "Breathe. Watch the ball. Push through." After a month of regular use, your performance under pressure improves significantly. Not because you stopped being nervous — but because you have a **system** instead of chaos.

### 5. Klíčový poznatek

Nahraď „nesmím" za „udělej". Instrukce porazí zákazy — vždy.

#### EN

Replace "I mustn't" with "do this." Instructions beat prohibitions — every time.
...
## Lekce 4 — Self-talk jako systém
*id: `perf-l-mn-selftalk-d` · typ: application · xp: 20*

### 1. Úvod lekce

# Self-talk jako systém
*ikona: Brain*

V této lekci pochopíš, proč je self-talk **volba, ne náhoda**. Projdeme si, jak si vytvořit osobní systém slov pro klíčové momenty a proč špičkoví sportovci mají self-talk jako rutinu.

#### EN

# Self-talk as a system
*icon: Brain*

In this lesson you'll understand why self-talk is **a choice, not chance**. We'll go through how to build a personal word system for key moments and why top athletes treat self-talk as a routine.

### 2. Text

Špičkoví sportovci mají dokumentované systémy self-talku. V klíčových momentech si říkají předem připravené věty — kombinaci distanced self-talk a konkrétních instrukcí. Není to show — je to funkční systém, který trénují stejně jako fyzické dovednosti.

#### EN

Top athletes have documented self-talk systems. In clutch moments they say pre-prepared sentences — a combination of distanced self-talk and concrete instructions. It's not a show — it's a functional system they train just like physical skills.
...
Jakýkoliv člověk na špičkové úrovni — sportovec, chirurg, pilot, řečník — má podobný systém. Rozdíl mezi výkonem pod tlakem a selháním je často jen v tom, **co si říkáš v hlavě**. Self-talk není luxus. Je to nástroj, který můžeš trénovat od dneška.

#### EN

Anyone at a top level — an athlete, a surgeon, a pilot, a speaker — has a similar system. The difference between performing under pressure and collapsing often comes down to **what you tell yourself in your head**. Self-talk isn't a luxury. It's a tool you can start training today.

### 5. Klíčový poznatek

Self-talk je volba. Vyber si přesná slova pro přesné situace — a výkon se změní.

#### EN

Self-talk is a choice. Pick the exact words for the exact situations — and your performance changes.
