...
# Sebevědomí pod tlakem
*EN: Confidence Under Pressure*

## Krátký popis

Sebevědomí pod tlakem není charakter — je to dovednost postavená na důkazech z minulých výkonů.

### EN

Confidence under pressure isn't character — it's a skill built on evidence from past performances.
...
Albert Bandura called this phenomenon self-efficacy — the belief that you can handle a specific task. It differs from general self-confidence in that it's tied to a specific skill and built on real experience. Self-efficacy grows in four ways: through mastery experiences (the strongest), observing similar people, encouragement from others, and managing your physical sensations. Under pressure, self-efficacy is what decides between "I'm going to freeze" and "I can do this."

## Příklad ze života

Karel má panickou hrůzu z veřejných vystoupení. Jeho kouč ho přiměl k sérii mikro-výkonů: první týden minutový projev k pěti lidem, druhý týden tři minuty k deseti, a tak dále. Každý zvládnutý krok přidal důkaz do jeho paměti. Po třech měsících bez problémů promluvil k 200 lidem — ne protože přestal cítit strach, ale protože měl důkazy, že to zvládne.

### EN

Karel is terrified of public speaking. His coach walked him through a series of micro-performances: the first week a one-minute talk to five people, the next week three minutes to ten, and so on. Every successful step added evidence to his memory. After three months he gave a talk to 200 people without a hitch — not because the fear went away, but because he had proof he could do it.

## Časté chyby

Lidé čekají, až budou „sebevědomí", a teprve pak zkusí výkon. Funguje to opačně: začni s malým výkonem a sebevědomí přijde z něj. Další chyba je srovnávat se s nejlepšími — self-efficacy roste hlavně z pozorování lidí podobných tobě.

### EN

People wait until they "feel confident" before they try performing. It works the other way around: start with a small performance and confidence follows. Another mistake is comparing yourself to the very best — self-efficacy mainly grows from watching people who are like you.

---

# Lekce

## Lekce 1 — Sebevědomí se buduje činy
*id: `perf-l-mn-confidence-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, proč **sebevědomí pod tlakem není charakter** — je to dovednost postavená na důkazech z minulých výkonů. Projdeme si koncept self-efficacy a proč činy budují víru víc než slova.
...
In this lesson you'll understand why **confidence under pressure isn't a personality trait** — it's a skill built on evidence from past performances. We'll go through the concept of self-efficacy and why actions build belief more than words.

### 2. Text

Představ si, že máš panickou hrůzu z veřejných vystoupení. Čekáš, až budeš „mít sebevědomí", a pak začneš mluvit. Ale sebevědomí takhle nefunguje — nečeká na tebe, musíš ho **vybudovat**. Jak? Sérií mikro-výkonů: první týden minutový projev k pěti lidem, druhý týden tři minuty k deseti, pak pět minut k dvaceti. Každý zvládnutý krok přidá důkaz do tvé paměti.

#### EN

Imagine you're terrified of public speaking. You're waiting until you "feel confident" before you start. But confidence doesn't work like that — it doesn't wait for you, you have to **build it**. How? Through a series of micro-performances: a one-minute talk to five people in week one, three minutes to ten in week two, then five minutes to twenty. Every successful step adds evidence to your memory.
...
- ❌ Mikro-výkony jsou jen způsob, jak si zvyknout na strach
  Habituace na strach je vedlejší efekt. Hlavní mechanismus je budování důkazů — tvůj mozek sbírá data, že to zvládáš.
...
- ❌ Micro-performances are just a way to get used to fear
  Getting used to fear is a side effect. The main mechanism is building evidence — your brain collects data that you can handle it.

### 4. Text

Psycholog Albert Bandura tomu říká **self-efficacy** — víra, že zvládneš konkrétní úkol. Liší se od obecného sebevědomí tím, že je vázaná na **konkrétní dovednost** a postavená na **reálných zkušenostech**. Po třech měsících mikro-výkonů můžeš bez problémů mluvit k 200 lidem — ne proto, že bys přestal cítit strach, ale proto, že máš důkazy, že to zvládneš.

#### EN

Psychologist Albert Bandura calls this **self-efficacy** — the belief that you can handle a specific task. It differs from general self-confidence in that it's tied to a **specific skill** and built on **real experience**. After three months of micro-performances, you can speak to 200 people without a hitch — not because the fear went away, but because you have proof you can do it.

### 5. Klíčový poznatek

Sebevědomí není charakter. Je to dovednost, kterou buduješ pomocí zvládnutých výkonů.

#### EN

Confidence isn't a personality trait. It's a skill you build through mastery experiences.
...
- ❌ Čekat, až budeš mít dost sebevědomí na to, aby ses přihlásil
  Klasická past. Sebevědomí přijde po výkonu, ne před ním.
...
- ❌ Waiting until you have enough confidence to sign up
  A classic trap. Confidence comes after performance, not before it.
...
## Lekce 2 — Čtyři zdroje self-efficacy
*id: `perf-l-mn-confidence-b` · typ: deep_dive · xp: 15*

### 1. Úvod lekce

# Čtyři zdroje sebevědomí
*ikona: Trophy*

V této lekci pochopíš **čtyři zdroje self-efficacy** podle Bandury — od nejsilnějšího po nejslabší. Zjistíš, proč přímá zkušenost porazí motivační řeč a proč příběhy „lidí jako ty" fungují.
...
In this lesson you'll understand **Bandura's four sources of self-efficacy** — from strongest to weakest. You'll find out why direct experience beats motivational speeches and why stories of "people like you" work.

### 2. Text

Bandura identifikoval čtyři zdroje self-efficacy, od nejsilnějšího po nejslabší:
...
Bandura identified four sources of self-efficacy, from strongest to weakest:
...
- ❌ Říct si „dokážu to" sto krát za sebou
  Afirmace bez základu v realitě nefunguje. Mozek věří důkazům, ne opakovaným slovům.
...
- ❌ Telling yourself "I can do this" a hundred times
  Affirmations with no foundation in reality don't work. The brain trusts evidence, not repeated words.

### 4. Text

Pozorování podobných lidí je druhý nejsilnější zdroj. Když vidíš, že někdo jako ty — stejný věk, podobné zkušenosti, podobné obavy — něco zvládl, tvůj mozek si řekne „pak to zvládnu i já". Proto jsou příběhy lidí „jako já" tak inspirativní — ne proto, že by byly motivační, ale proto, že **dodávají důkaz**.

#### EN

Observing similar people is the second strongest source. When you see someone like you — same age, similar experience, similar fears — pull something off, your brain concludes "then I can pull it off too." That's why stories about people "like me" are so inspiring — not because they're motivational, but because they **provide evidence**.

### 5. Klíčový poznatek

Nejrychlejší cesta k sebevědomí: zvládni něco malého podobného. Důkazy porazí afirmace.

#### EN

The fastest path to confidence: pull off something small and similar. Evidence beats affirmations.
...
## Lekce 3 — Self-efficacy v praxi
*id: `perf-l-mn-confidence-c` · typ: application · xp: 15*

### 1. Úvod lekce

# Budování sebevědomí krok za krokem
*ikona: Trophy*

V této lekci si vyzkoušíš, jak **aplikovat princip self-efficacy** v běžném životě. Pochopíš, proč je první krok — i malý a nedokonalý — základ pro všechno ostatní.
...
In this lesson you'll practice **applying the self-efficacy principle** in everyday life. You'll understand why the first step — even small and imperfect — is the foundation for everything else.

### 2. Text

Představ si, že chceš začít natáčet videa, ale bojíš se. Máš pocit, že „nejsi ten typ". Roky jen přemýšlíš, ale nic nezkusíš. Rozhodneš se použít princip self-efficacy. Tvůj první krok: natočit krátké video, které nikdy nezveřejníš. Jen aby sis měl důkaz, že to dokážeš.

#### EN

Imagine you want to start making videos, but you're scared. You feel like you're "not the type." For years you just think about it without trying anything. You decide to use the self-efficacy principle. Your first step: record a short video you'll never publish. Just to have proof that you can do it.
...
Natočíš první video, pak druhé, pak jedno zveřejníš. Za půl roku máš 50 videí a tisíce sledujících. Všechno začalo jedním nezveřejněným videem. Sebevědomí nepřišlo před prvním krokem — **přišlo z něj**.

#### EN

You record the first video, then the second, then you publish one. Within six months you have 50 videos and thousands of subscribers. It all started with one unpublished video. Confidence didn't come before the first step — **it came from it**.

### 5. Klíčový poznatek

Buduj důkazy postupně. Každý zvládnutý mikro-výkon je cihla do zdi tvého sebevědomí.

#### EN

Build evidence step by step. Every successful micro-performance is another brick in the wall of your confidence.
...
## Lekce 4 — Sebevědomí je sval
*id: `perf-l-mn-confidence-d` · typ: application · xp: 20*
...
V této lekci pochopíš, proč je sebevědomí **proces, ne stav** — musíš ho neustále obnovovat a budovat. Zjistíš, jak pracovat s neúspěchem a proč i špičkoví sportovci musí sebevědomí znovu stavět po každé prohře.
...
In this lesson you'll understand why confidence is a **process, not a state** — you have to keep rebuilding it. You'll find out how to work with failure and why even top athletes have to rebuild confidence after every loss.

### 2. Text

Představ si špičkovou tenistku, která v důležitých momentech zápasu zní naprosto sebevědomě. Ale v rozhovorech přiznala: „Sebevědomí jsem si musela postavit po každé prohře znovu." Ani elita nemá „přirozené" sebevědomí. Je to proces — neustálý cyklus budování, otřesu a znovupostavení.

#### EN

Imagine a top tennis player who sounds utterly confident in the biggest moments of a match. But in interviews she admitted: "I had to rebuild my confidence after every loss." Even the elite don't have "natural" confidence. It's a process — a constant cycle of building, shaking, and rebuilding.
...
Metoda po neúspěchu: nejdřív analýza (co se dá zlepšit), pak série malých úspěchů v tréninku, pak větší úspěch, pak návrat do ostrého výkonu. Cyklus důkazů, který obnovuje self-efficacy. Ne motivační citáty — **činy**.

#### EN

The method after failure: first analysis (what can be improved), then a series of small wins in practice, then a bigger win, then back into real performance. A cycle of evidence that rebuilds self-efficacy. Not motivational quotes — **actions**.

### 5. Klíčový poznatek

Sebevědomí je sval, který trénuješ. Každý den, každý výkon, každý malý úspěch. Bez činů neexistuje.

#### EN

Confidence is a muscle you train. Every day, every performance, every small win. Without action it doesn't exist.
