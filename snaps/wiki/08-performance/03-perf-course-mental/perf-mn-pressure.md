...
Tlak není tvůj nepřítel — je to fyziologický stav, který můžeš přerámovat z hrozby na výzvu.

### EN

Pressure isn't your enemy — it's a physiological state you can reframe from a threat into a challenge.
...
Under pressure, the stress response kicks in — your heart races, your breathing speeds up, your body shifts into fight-or-flight. The response itself isn't harmful; what's harmful is how you interpret it. Alia Crum's research shows that people who see stress as "a challenge that gives me energy" perform better under pressure than those who see it as a "threat." Beyond reframing, it also helps to breathe (slow exhales) and to focus on the process instead of the outcome.

## Příklad ze života

Pavel je chirurg. Před operací cítí buchot srdce a pocení. Dřív to považoval za panický útok. Pak se naučil to interpretovat jako „moje tělo se připravuje na přesný výkon" — a ten samý stav najednou pomáhal místo aby škodil. Výsledky operací se zlepšily.

### EN

Pavel is a surgeon. Before an operation he feels his heart pounding and his palms sweating. He used to think it was a panic attack. Then he learned to read it as "my body is preparing for a precise performance" — and the same state suddenly helped instead of hurt. His surgical outcomes improved.

## Časté chyby

Lidé se snaží stres „zbavit" — uklidnit se, nebýt nervózní. Jenže stres je signál, že ti záleží; úplný klid pod velkým tlakem je biologicky nemožný. Cílem není nulový stres, ale přeformulovat ho na zdroj energie.

### EN

People try to "get rid of" stress — calm down, stop being nervous. But stress is a signal that you care; complete calm under high pressure is biologically impossible. The goal isn't zero stress, but reframing it into a source of energy.

---

# Lekce

## Lekce 1 — Stres jako energie
*id: `perf-l-mn-pressure-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, proč **tlak není tvůj nepřítel** — je to fyziologický stav, který můžeš přerámovat z hrozby na výzvu. Projdeme si, jak stresová reakce funguje a proč její interpretace rozhoduje o výkonu.
...
In this lesson you'll understand why **pressure isn't your enemy** — it's a physiological state you can reframe from a threat into a challenge. We'll go through how the stress response works and why your interpretation of it determines your performance.

### 2. Text

Představ si, že stojíš před důležitým výkonem. Buší ti srdce, potíš se, dýchání se zrychluje. Tvůj první instinkt je: „Mám panický útok, nezvládnu to." Ale ty samé fyzické pocity zažívají sportovci před závodem — a oni je interpretují jako „moje tělo se připravuje". Stresová reakce sama o sobě není škodlivá. Škodlivé je, **jak ji interpretuješ**.
...
- ❌ Záleží na tom, jak velký stres je — malý pomáhá, velký škodí
  Velikost stresu je méně důležitá než jeho interpretace. I silný stres může pomáhat, pokud ho vnímáš jako zdroj energie.
...
- ❌ It depends on how big the stress is — small helps, big hurts
  The size of the stress matters less than its interpretation. Even strong stress can help if you see it as a source of energy.

### 4. Text

Řekneš si: „Moje tělo se připravuje na přesný výkon." Stejné bušení srdce, ale jiný příběh. Přerámování neodstraní pocity — změní jejich **význam**. A to mění výkon.

#### EN

You tell yourself: "My body is preparing for a precise performance." Same racing heart, different story. Reframing doesn't remove the sensations — it changes their **meaning**. And that changes your performance.

### 5. Klíčový poznatek

Stres není nepřítel. Je to energie, kterou můžeš přerámovat z hrozby na zdroj.

#### EN

Stress isn't an enemy. It's energy you can reframe from a threat into a resource.
...
## Lekce 2 — Vnímání stresu mění tělo
*id: `perf-l-mn-pressure-b` · typ: deep_dive · xp: 15*

### 1. Úvod lekce

# Vnímání stresu mění biologii
*ikona: AlertCircle*

V této lekci pochopíš výzkum Alie Crumové ze Stanfordu: **jak vnímáš stres, tak na něj tvé tělo reaguje**. Zjistíš, že interpretace stresu mění nejen výkon, ale i hormony a imunitu.

#### EN

# Stress perception changes biology
*icon: AlertCircle*

In this lesson you'll understand Alia Crum's research from Stanford: **how you perceive stress is how your body responds to it**. You'll find out that interpreting stress differently changes not only performance, but also hormones and immunity.

### 2. Text

Alia Crum ze Stanfordu provedla slavný experiment: jedné skupině řekla, že stres je zdravý a užitečný — dává energii, zaostřuje pozornost. Druhé skupině dala tradiční informaci, že stres je škodlivý. Třetí byla kontrolní. Po několika týdnech měřila výkon, hormony a imunitu.

#### EN

Alia Crum at Stanford ran a famous experiment: she told one group that stress is healthy and useful — it gives energy, sharpens focus. She told the second group the traditional message that stress is harmful. The third was a control. After several weeks she measured performance, hormones, and immunity.
...
- ❌ Řekneš si, že na schůzce nezáleží
  Pokud na ní záleží, mozek to ví a lež nepřijme. Lepší je přijmout, že záleží, a stres přerámovat na zdroj.
...
- ❌ You tell yourself the meeting doesn't matter
  If it does matter, the brain knows and won't accept the lie. Better to accept that it matters and reframe the stress as a resource.
...
## Lekce 3 — Přerámování v praxi
*id: `perf-l-mn-pressure-c` · typ: application · xp: 15*
...
V této lekci si vyzkoušíš **přerámování stresu v konkrétních situacích** — při pohovoru, zkoušce nebo prezentaci. Pochopíš, že přerámování neodstraní pocity, ale změní jejich význam.
...
In this lesson you'll practice **reframing stress in concrete situations** — during a job interview, an exam, or a presentation. You'll understand that reframing doesn't remove the sensations but changes their meaning.

### 2. Text

Představ si, že máš za hodinu důležitý pohovor. Buší ti srdce, potíš se, nemůžeš se soustředit. Chceš jít domů. Pak si vzpomeneš na techniku přerámování. Místo „jsem nervózní a nezvládnu to" si řekneš: „Moje tělo mi dává energii. Ta energie mi pomůže se soustředit a reagovat rychle."

#### EN

Imagine you have an important interview in an hour. Your heart is pounding, you're sweating, you can't concentrate. You want to go home. Then you remember the reframing technique. Instead of "I'm nervous and I can't do this," you tell yourself: "My body is giving me energy. That energy will help me focus and react quickly."
...
Pohovor dopadl dobře. Srdce ti bušilo po celou dobu, ale bušení už nebylo důkazem selhání — bylo důkazem zapojení. Tento rozdíl mění všechno. Nepotlačuj stres. **Přerámuj ho.**

#### EN

The interview went well. Your heart was pounding the whole time, but the pounding was no longer proof of failure — it was proof of engagement. That difference changes everything. Don't suppress stress. **Reframe it.**

### 5. Klíčový poznatek

Nepotlačuj stres. Přerámuj ho. „Moje tělo mi dává palivo pro výkon."

#### EN

Don't suppress stress. Reframe it. "My body is giving me fuel to perform."
...
## Lekce 4 — Choking under pressure
*id: `perf-l-mn-pressure-d` · typ: application · xp: 20*

### 1. Úvod lekce

# Proč pod tlakem selháváme
*ikona: AlertCircle*

V této lekci pochopíš fenomén **„choking under pressure"** — proč lidé selhávají ne proto, že by neuměli, ale proto, že **začnou příliš přemýšlet**. Naučíš se techniku externího fokusu.
...
Řešení pod tlakem: místo sebeanalýzy zaměř pozornost ven — na cíl, na publikum, na míč. **Interní fokus** (jak vypadám, co dělám) rozbíjí výkon. **Externí fokus** (co potřebuje publikum slyšet, kam letí míč) ho chrání.

#### EN

The solution under pressure: instead of self-analysis, point your attention outward — at the target, the audience, the ball. **Internal focus** (how do I look, what am I doing) breaks performance. **External focus** (what does the audience need to hear, where is the ball going) protects it.

### 5. Klíčový poznatek

Pod tlakem zaměř pozornost ven — na cíl, ne na sebe. Externí fokus chrání výkon.

#### EN

Under pressure, point your attention outward — at the target, not yourself. External focus protects your performance.
