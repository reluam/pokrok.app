...
Pozornost je omezený zdroj — nemůžeš se věnovat všemu najednou, ať se snažíš sebevíc.

### EN

Attention is a limited resource — you can't give yourself to everything at once, no matter how hard you try.
...
The brain has a bottleneck: at any moment, it can only consciously process very little information. "Multitasking" doesn't really exist — when you do two things at once, your brain rapidly switches between them and loses energy with every switch. Focused attention is like muscle work — it takes effort, gets tired, and can be trained. It splits into focused (concentrated on one thing) and divided (tracking multiple inputs), but even divided attention is just fast switching.

## Příklad ze života

Martina píše e-mail a zároveň sleduje Instagram. E-mail, který by jí normálně zabral 5 minut, píše 20 minut a pak v něm najde tři chyby. Každé kliknutí na telefon „smaže" kontext a mozek musí znovu najíždět — tomu se říká switch cost.

### EN

Martina is writing an email while checking Instagram. An email that would normally take 5 minutes takes her 20, and she still finds three typos. Every tap on the phone "wipes" the context and her brain has to load everything back up — that's called switch cost.

## Časté chyby

Lidé jsou hrdí na multitasking, ale výzkumy ukazují, že ti, kdo často „multitaskují", jsou paradoxně horší v soustředění i v samotném přepínání. Další chyba: obviňovat se ze „slabé vůle", když se nedaří soustředit — většinou jde o příliš mnoho vnějších vjemů a nevhodné prostředí.

### EN

People are proud of multitasking, but research shows that heavy "multitaskers" are paradoxically worse at both focusing and switching itself. Another mistake: blaming "weak willpower" when you can't focus — usually it's just too many external inputs and a bad environment.

---

# Lekce

## Lekce 1 — Co je pozornost
*id: `hf-l-brain-attention-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, co **pozornost** ve skutečnosti je a proč ji nemůžeš dávat všemu najednou. Projdeme si, jak funguje „úzké hrdlo" mozku a proč je **multitasking mýtus**.
...
In this lesson you'll understand what **attention** really is and why you can't give it to everything at once. We'll go through the brain's "bottleneck" and why **multitasking is a myth**.

### 2. Text

Pozornost je **omezený zdroj**. Mozek má úzké hrdlo — v jednu chvíli dokáže vědomě zpracovávat jen velmi málo informací najednou. Nejde o slabost ani o vadu. Je to technická vlastnost, se kterou se rodí každý člověk.
...
Attention is a **limited resource**. The brain has a bottleneck — at any given moment, it can only consciously process very little information. It's not a weakness or a defect. It's a technical property everyone is born with.
...
- ❌ Tvůj mozek je unavený a potřebuje víc kávy
  Káva může dočasně pomoct, ale neřeší podstatu problému — ta je v kapacitě pozornosti, ne v úrovni energie.
...
- ❌ Your brain is tired and needs more coffee
  Coffee can temporarily help, but it doesn't fix the core of the problem — that's in the capacity of attention, not energy levels.

### 4. Text

**Multitasking ve skutečnosti neexistuje.** Když „děláš dvě věci najednou", tvůj mozek mezi nimi rychle přepíná a pokaždé ztrácí energii i čas. Tomuto se říká **switch cost** — cena přepnutí.
...
**Multitasking doesn't really exist.** When you "do two things at once," your brain is rapidly switching between them and loses energy and time with each switch. This is called **switch cost** — the price of switching.
...
- ❌ Budeš efektivní, protože tvůj mozek trénuje multitasking
  „Trénink multitaskingu" je mýtus. Výzkumy ukazují, že ti, kdo často přepínají, jsou paradoxně horší v soustředění — ne lepší.
...
- ❌ You'll be effective because your brain is training multitasking
  "Training multitasking" is a myth. Research shows people who switch often are paradoxically worse at focusing — not better.

### 6. Text

Pozornost se dělí na dva režimy. **Zaměřená pozornost** je ta, kterou řídíš vědomě — soustředíš ji na jeden úkol. **Rozptýlená pozornost** je automatická — mozek skenuje okolí, aby zachytil něco důležitého (zvuk, pohyb, nové upozornění).
...
Attention splits into two modes. **Focused attention** is the kind you run consciously — you aim it at one task. **Diffuse attention** is automatic — your brain scans the surroundings to catch anything important (a sound, a movement, a new notification).
...
- ❌ Mozek si rychle zvykne a notifikace ho přestanou rušit
  Naopak — čím víc notifikací máš, tím víc si na ně mozek zvyká a tím silněji reaguje. Zvyk ti pomáhá jen v tom, že si to přestaneš uvědomovat, ne že to přestaneš platit.
...
- ❌ Your brain gets used to it quickly and notifications stop distracting you
  On the contrary — the more notifications you have, the more your brain gets used to them and the stronger it reacts. Habit only helps in that you stop noticing it, not that it stops costing you.

### 8. Klíčový poznatek

**Pozornost je jako reflektor.** Když ho rozptýlíš na deset věcí, žádnou z nich pořádně neosvítíš. Mozek neumí skutečný multitasking — umí jen rychle přepínat, a každé přepnutí tě něco stojí.

#### EN

**Attention is like a spotlight.** If you scatter it across ten things, you don't light up any of them properly. The brain can't do real multitasking — it can only switch fast, and every switch costs you something.
...
- ❌ Mají slabší vůli a méně motivace než ostatní
  Studie tento rozdíl ukazují i u lidí se stejně silnou motivací. Rozdíl je v tom, na co je jejich mozek trénovaný — přepínání versus hluboká práce.
...
- ❌ They have weaker willpower and less motivation than others
  Studies show this difference even in people with equally strong motivation. The difference is what their brain is trained for — switching versus deep work.
...
- ❌ Dát si ve sluchátkách hlasitou hudbu s texty, abys odstínil okolí
  Sluchátka s klidnou instrumentální hudbou mohou pomoct, ale texty písní obsahují slova — a ta soupeří s jazykovou částí mozku, která píše zprávu.
...
- ❌ Play loud music with lyrics in headphones to block out the environment
  Headphones with calm instrumental music can help, but song lyrics contain words — and those compete with the language part of the brain that's writing the report.

## Lekce 2 — Jak pozornost skutečně funguje
*id: `hf-l-brain-attention-b` · typ: deep_dive · xp: 15*
...
V této lekci se podíváme **pod pokličku** pozornosti. Pochopíš, proč má mozek tak malý limit pracovní paměti, co je **decision fatigue** a proč po náročném dni nedokážeš udělat ani jednoduché rozhodnutí.
...
In this lesson we'll look **under the hood** of attention. You'll understand why the brain has such a small working memory limit, what **decision fatigue** is, and why after a hard day you can't even make a simple decision.

### 2. Text

Mozek má malý limit pracovní paměti — drží jen asi **4 položky najednou**. Není to slabost, je to architektura. Stejně jako počítač s omezenou RAM — když mu dáš víc úloh, než zvládne, všechno zpomalí.
...
The brain has a small working memory limit — it holds only about **4 items at a time**. It's not a weakness, it's architecture. Just like a computer with limited RAM — when you give it more tasks than it can handle, everything slows down.
...
- ❌ Číslo se zapsalo špatně do dlouhodobé paměti
  Dlouhodobá paměť s tímto nemá nic společného. Problém je v pracovní paměti, která číslo ani nestihla „podržet".
...
- ❌ The number was written incorrectly into long-term memory
  Long-term memory has nothing to do with this. The problem is in working memory, which didn't even manage to "hold" the number.

### 4. Text

Každé rozhodnutí, které během dne uděláš, stojí mozek trochu energie. Po mnoha rozhodnutích se dostaví **decision fatigue** — unavená pozornost, která má problém i s banalitami.
...
Every decision you make during the day costs your brain a little energy. After many decisions, **decision fatigue** sets in — tired attention that struggles even with trivial things.
...
- ❌ Máš hlad a nízkou hladinu cukru v krvi
  Hladina cukru může hrát roli, ale hlavní mechanismus je vyčerpaná pozornost z rozhodování, ne jen glukóza.
...
- ❌ You're hungry and have low blood sugar
  Blood sugar can play a role, but the main mechanism is depleted attention from decisions, not just glucose.

### 6. Text

**Pozornost je jako sval.** Když ji trénuješ, sílí. Když ji necháváš ležet (nebo naopak neustále přepínáš), slábne. To znamená dobrou zprávu i špatnou zprávu.
...
**Attention is like a muscle.** When you train it, it gets stronger. When you let it lie (or, conversely, constantly switch), it weakens. That means both good news and bad news.
...
- ❌ Máš úzkostnou poruchu, kterou by ses měl nechat vyšetřit
  Pokud úzkost souvisí výhradně se změnou pracovního režimu a ne s širším kontextem, je to normální reakce na odvykání. Doktora potřebuješ, pokud úzkost přetrvává i v jiných situacích.
...
- ❌ You have an anxiety disorder and should get checked out
  If the anxiety is related solely to the change in work mode and not to a broader context, it's a normal reaction to withdrawal. You need a doctor if the anxiety persists in other situations too.

### 8. Klíčový poznatek

**Pozornost má pevnou kapacitu, která se během dne vyčerpává.** Decision fatigue je normální jev — a jediné, co s ním opravdu funguje, je méně rozhodnutí a méně přepínání, ne víc vůle.

#### EN

**Attention has a fixed capacity that gets used up throughout the day.** Decision fatigue is a normal phenomenon — and the only thing that really works against it is fewer decisions and less switching, not more willpower.
...
- ❌ Problém je v tom, že ráno ještě nejsou plně probuzeni
  Probuzenost je jiná věc. I plně probuzený člověk, který udělal 50 malých rozhodnutí dopoledne, má odpoledne zhoršenou schopnost rozhodovat.
...
- ❌ The problem is that they're not fully awake in the morning yet
  Wakefulness is a different thing. Even a fully awake person who made 50 small decisions in the morning has worse decision-making ability in the afternoon.
...
- ❌ Zlepší se ti pozornost, protože máš telefon „pod kontrolou"
  Naopak. „Mít ho pod kontrolou" znamená pouze, že mu věnuješ část pozornosti. Ta pak chybí jinde.
...
- ❌ Your attention will improve because you have the phone "under control"
  On the contrary. "Having it under control" only means you're giving it part of your attention. That part is then missing elsewhere.

## Lekce 3 — Jak trénovat pozornost v praxi
*id: `hf-l-brain-attention-c` · typ: application · xp: 20*
...
Teorii znáš. V této lekci se podíváme, jak **pozornost trénovat v každodenním životě** — jaké návyky fungují, jaké jsou mýty a proč „deep work" blok dopoledne může změnit celý tvůj týden.
...
You know the theory. In this lesson we'll look at how to **train attention in everyday life** — which habits work, which are myths, and why a "deep work" block in the morning can change your entire week.

### 2. Text

První a nejmocnější nástroj je **prostředí, ne vůle**. Když máš v pokoji telefon, otevřený Slack a televizi, žádná „silná vůle" tě před rozptýlením neochrání — vůle je křehký zdroj, prostředí je pevný rámec.
...
The first and most powerful tool is **environment, not willpower**. When you have your phone, open Slack, and a TV in your room, no "strong willpower" will protect you from distraction — willpower is a fragile resource, the environment is a firm frame.
...
**Otázka:** Představ si, že chceš zlepšit svou schopnost soustředit se. Která z těchto změn ti pravděpodobně přinese nejrychlejší zlepšení?

- **✅ Dát telefon během práce fyzicky do druhé místnosti**
  Přesně. Fyzická vzdálenost dělá obrovský rozdíl — prokazatelně víc než „silnější vůle" nebo „víc kávy". Studie ukazují, že už samotná přítomnost telefonu na stole snižuje výkon. Když je v jiné místnosti, mozek ho přestane „hlídat".
- ❌ Koupit si drahá sluchátka s aktivním potlačením hluku
  Pomohou s vnějším hlukem, ale nevyřeší hlavního rušiče — telefon. A mnoho lidí si s nimi stejně pustí rozptylující hudbu nebo podcast.
- ❌ Začít pít víc kávy, aby tvůj mozek „jel na plno"
  Káva může krátkodobě pomoct, ale neřeší strukturální problém — přítomnost rušičů a nepřetržité přepínání.

#### EN

**Question:** Imagine that you want to improve your ability to focus. Which of these changes is most likely to bring the fastest improvement?

- **✅ Physically put your phone in another room during work**
  Exactly. Physical distance makes a huge difference — demonstrably more than "stronger willpower" or "more coffee." Studies show that the mere presence of a phone on the desk lowers performance. When it's in another room, the brain stops "guarding" it.
- ❌ Buy expensive headphones with active noise cancellation
  They help with external noise, but they don't solve the main distractor — the phone. And many people still play distracting music or a podcast through them.
- ❌ Start drinking more coffee so your brain "runs at full speed"
  Coffee can help short-term, but it doesn't solve the structural problem — the presence of distractors and constant switching.

### 4. Text

Druhým nástrojem je **práce v blocích**. Nejznámější metoda je **Pomodoro**: 25 minut soustředěné práce + 5 minut pauza. Pro pokročilejší to jsou **deep work bloky** — 90 až 120 minut bez přerušení, obvykle ráno, kdy je mozek nejčerstvější.
...
The second tool is **working in blocks**. The most famous method is **Pomodoro**: 25 minutes of focused work + 5 minutes of break. For more advanced, there's the **deep work block** — 90 to 120 minutes without interruption, usually in the morning when the brain is freshest.
...
- ❌ Během bloku si dát pauzu s telefonem, abys si odpočinul
  Telefon není odpočinek — je to rušič, který tě vytáhne z kontextu. Pauza má být bez vjemů (procházka, voda, okno), ne nový „input".
...
- ❌ During the block take a break with your phone to relax
  The phone isn't rest — it's a distractor that pulls you out of context. A break should be without inputs (a walk, water, a window), not a new "input."

### 6. Text

Třetí nástroj: **meditace, i když ji nenávidíš**. Dlouhé výzkumy ukazují, že i **10 minut denně** prokazatelně trénují pozornost. Nemusíš být mnich — stačí sedět, dýchat a když ti pozornost uteče, vrátit ji zpět k dechu. A znovu. A znovu.
...
The third tool: **meditation, even if you hate it**. Long-term research shows that even **10 minutes a day** demonstrably trains attention. You don't have to be a monk — it's enough to sit, breathe, and when your attention wanders, bring it back to the breath. And again. And again.
...
- ❌ Jediný účinek meditace je relaxace, pozornost s tím nesouvisí
  Relaxace je jedním z efektů, ale výzkumy jasně ukazují, že meditace přímo zlepšuje výkon v testech pozornosti — i u lidí, kteří „neuměli meditovat".
...
- ❌ The only effect of meditation is relaxation, attention has nothing to do with it
  Relaxation is one of the effects, but research clearly shows that meditation directly improves performance on attention tests — even in people who "couldn't meditate."

### 8. Klíčový poznatek

**Pozornost je dovednost, ne dar.** Nikdo se nerodí s „železnou pozorností" — lidé, kteří se dokážou hluboko soustředit, ji dlouhodobě trénovali prostředím, bloky a opakováním. Dobrá zpráva je, že ty můžeš taky.

#### EN

**Attention is a skill, not a gift.** Nobody is born with "iron attention" — people who can focus deeply trained it long-term through environment, blocks, and repetition. The good news is that you can too.
...
- ❌ Nemáš dost vůle, musíš se víc snažit
  Vůle je křehký zdroj. Když tě okolí táhne pryč, žádná vůle dlouho nevydrží. Řešením je prostředí, ne víc snahy.
...
- ❌ You don't have enough willpower, you just have to try harder
  Willpower is a fragile resource. When your environment is pulling you away, no willpower holds long. The solution is the environment, not more effort.
...
- ❌ Mají ADHD a potřebují medikaci
  ADHD existuje, ale je výrazně méně časté než obecná ztráta pozornosti způsobená přepínáním. Nejdřív zkus změnu prostředí a návyků; pokud to nepomůže a problém je dlouhodobý, zvaž odbornou konzultaci.
...
- ❌ They have ADHD and need medication
  ADHD exists, but it's significantly less common than general attention loss caused by switching. First try changing the environment and habits; if it doesn't help and the problem is long-term, consider a professional consultation.
