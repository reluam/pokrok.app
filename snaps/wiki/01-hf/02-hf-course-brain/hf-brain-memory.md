...
Paměť není jedna — máme krátkodobou, pracovní a dlouhodobou a každá funguje jinak.

### EN

Memory isn't one thing — we have short-term, working, and long-term memory, and each one works differently.

## Plné vysvětlení

Pracovní paměť je jako „stůl" mozku — drží několik položek najednou (přibližně 4–7) a umožňuje s nimi pracovat. Dlouhodobá paměť je „sklad", kam se ukládají vzpomínky, fakta a dovednosti. Aby se informace dostala do dlouhodobé paměti, musí ji mozek aktivně zpracovat — nejlepší je vybavování, spojování s tím, co už víš, a opakování v rozestupech (spaced repetition). Největší část upevňování probíhá během spánku, hlavně v hluboké fázi.

### EN

Working memory is like your brain's "desk" — it holds several items at once (about 4–7) and lets you work with them. Long-term memory is the "warehouse" where memories, facts, and skills are stored. For information to get into long-term memory, your brain has to actively process it — the best way is recall, linking to what you already know, and repetition at intervals (spaced repetition). Most of the consolidation happens during sleep, especially the deep phase.

## Příklad ze života

Tomáš se učí slovíčka z angličtiny. Když jen pasivně čte seznam, druhý den si pamatuje pětinu. Když ale zavře seznam a zkusí si slova vybavit zpaměti, druhý den jich zná víc než polovinu. Vybavování je aktivní trénink — čtení je jen pasivní iluze učení.

### EN

Tomáš is learning English vocabulary. When he just passively reads the list, the next day he remembers a fifth of it. But when he closes the list and tries to recall the words from memory, the next day he knows more than half. Recall is active training — reading is just a passive illusion of learning.

## Časté chyby

Nejčastější chyba: podtrhávat a znovu číst místo aktivního vybavování. Další mýtus je „fotografická paměť" — neexistuje ve formě, v jaké si ji lidé představují. Každá vzpomínka je rekonstrukce, ne přesná kopie.

### EN

The most common mistake: highlighting and rereading instead of active recall. Another myth is "photographic memory" — it doesn't exist in the form people imagine. Every memory is a reconstruction, not an exact copy.
...
## Lekce 1 — Co je paměť
*id: `hf-l-brain-memory-a` · typ: intro · xp: 10*
...
V této lekci pochopíš, že **paměť není jedna** — tvůj mozek má pracovní paměť (stůl), dlouhodobou paměť (sklad) a krátkodobou mezistopku. Projdeme si, jak fungují, proč zapomínáš a proč **fotografická paměť neexistuje**.
...
In this lesson you'll understand that **memory isn't one thing** — your brain has working memory (a desk), long-term memory (a warehouse), and a short-term buffer. We'll go through how they work, why you forget, and why **photographic memory doesn't exist**.

### 2. Text

Tvůj mozek nemá jednu „paměť". Má minimálně tři různé systémy:
...
Your brain doesn't have one "memory." It has at least three different systems:
...
- ❌ Krátkodobou paměť — protože si to pamatuješ jen chvíli
  Krátkodobá paměť a pracovní paměť se překrývají, ale v tomto scénáři aktivně s číslem „pracuješ" (opakuješ si ho) — to je typická role pracovní paměti.
...
- ❌ Short-term memory — because you remember it only briefly
  Short-term and working memory overlap, but in this scenario you're actively "working" with the number (repeating it) — that's a typical role of working memory.

### 4. Text

Aby se informace dostala z pracovní paměti do **dlouhodobé**, musí ji mozek aktivně zpracovat. Tři nejefektivnější způsoby:
...
For information to move from working memory into **long-term**, the brain has to actively process it. The three most effective ways:
...
- ❌ Dlouhodobá paměť se plní pomalu a přijímá jen určité množství informací denně
  Kapacita dlouhodobé paměti je prakticky neomezená. Problém není v limitu, ale ve způsobu „doručení" — pasivní čtení je špatný kurýr.
...
- ❌ Long-term memory fills up slowly and only accepts a certain amount of information per day
  The capacity of long-term memory is practically unlimited. The problem isn't in the limit, but in the way of "delivery" — passive reading is a bad courier.

### 6. Text

Zajímavý fakt: mozek zapomíná podle **křivky zapomínání** (Ebbinghausova křivka). Většina nových informací se ztratí během prvních **24 hodin** — pokud si je aktivně nevybavíš. Ale každé opakování křivku „zvedá" — po prvním zopakování si pamatuješ déle, po druhém ještě déle.
...
An interesting fact: the brain forgets according to the **forgetting curve** (Ebbinghaus curve). Most new information is lost within the first **24 hours** — if you don't actively recall it. But each repetition "lifts" the curve — after the first review you remember longer, after the second even longer.
...
- ❌ Asi 15 z 20 — přečtení stačí na většinu
  I to je příliš optimistické. Bez aktivního vybavování je retence po 24 hodinách typicky pod 30 %.
...
- ❌ About 15 of 20 — reading is enough for most
  Even that's too optimistic. Without active recall, retention after 24 hours is typically below 30 %.

### 8. Klíčový poznatek

**Paměť není jeden systém, ale tři.** Pracovní paměť má pevný strop (4–7 položek), dlouhodobá paměť má téměř neomezenou kapacitu — ale informace se do ní dostane jen tehdy, když ji mozek aktivně zpracuje. A bez opakování většinu zapomeneš do 24 hodin.

#### EN

**Memory isn't one system, it's three.** Working memory has a fixed ceiling (4–7 items), long-term memory has nearly unlimited capacity — but information only gets there when the brain actively processes it. And without repetition, you forget most within 24 hours.
...
- ❌ Nemusíš se ho snažit vybavit — mozek si ho zapamatuje automaticky, pokud na tebe ten člověk udělá dojem
  Emoční dojem pomáhá (amygdala posiluje paměťové stopy), ale i tak aktivní vybavování je mnohem spolehlivější než „čekat na dojem".
...
- ❌ You don't need to try to recall it — the brain remembers it automatically if the person makes an impression on you
  Emotional impression helps (the amygdala strengthens memory traces), but even so, active recall is much more reliable than "waiting for an impression."
...
- ❌ Neexistuje žádný rozdíl — jde o stejný systém s různým názvem
  Jsou to odlišné systémy s různou kapacitou, trváním a mechanismy. Poškození jednoho nemusí poškodit druhý.
...
- ❌ There's no difference — it's the same system with a different name
  They're distinct systems with different capacities, durations, and mechanisms. Damage to one doesn't necessarily damage the other.
...
- ❌ Přepsat poznámky do čistého dokumentu
  Přepisování je poloaktivní — o něco lepší než nic, ale mnohem horší než aktivní vybavování z hlavy.
...
- ❌ Rewrite the notes into a clean document
  Rewriting is semi-active — somewhat better than nothing, but much worse than active recall from your head.

## Lekce 2 — Jak paměť funguje a co ji ovlivňuje
*id: `hf-l-brain-memory-b` · typ: deep_dive · xp: 15*
...
V této lekci se podíváme na to, **jak mozek rozhoduje, co si zapamatovat** — a proč jsou vzpomínky **rekonstrukce**, ne přesné záznamy. Pochopíš, proč spánek je klíčový a proč ti paměť může lhát.
...
In this lesson we'll look at **how the brain decides what to remember** — and why memories are **reconstructions**, not exact recordings. You'll understand why sleep is key and why your memory can lie to you.

### 2. Text

Největší konsolidace paměti probíhá **během spánku**. V hluboké fázi spánku (pomalé vlny) se informace přesouvají z hippocampu (dočasné úložiště) do neokortexu (trvalé úložiště). V REM fázi (snění) se propojují emoční a faktuální vzpomínky.
...
The greatest memory consolidation happens **during sleep**. In the deep sleep phase (slow waves), information moves from the hippocampus (temporary storage) into the neocortex (permanent storage). In the REM phase (dreaming), emotional and factual memories are connected.
...
- ❌ Zhoršení bude minimální — důležitější je, kolik hodin jsi strávil/a učením
  Čas učení je důležitý, ale bez spánku se velká část této investice ztratí. Spánek je „poslední krok" učení.
...
- ❌ The impairment will be minimal — more important is how many hours you spent studying
  Study time is important, but without sleep a large part of that investment is lost. Sleep is the "last step" of learning.

### 4. Text

Další důležitá věc o paměti: **vzpomínky nejsou přesné záznamy**. Každá vzpomínka je **rekonstrukce** — pokaždé, když si na něco vzpomeneš, mozek to „znovu sestaví" z částí uložených na různých místech. A pokaždé to může sestavit trochu jinak.
...
Another important thing about memory: **memories aren't exact recordings**. Every memory is a **reconstruction** — each time you recall something, your brain "reassembles" it from parts stored in different places. And each time it may assemble it slightly differently.
...
- ❌ Děti mají špatnou paměť — dětské vzpomínky jsou vždy zkreslené
  Děti mají jinak fungující paměť, ale to neznamená, že je „vždy zkreslená". I dospělé vzpomínky jsou rekonstrukce.
...
- ❌ Children have bad memory — childhood memories are always distorted
  Children have differently functioning memory, but that doesn't mean it's "always distorted." Even adult memories are reconstructions.

### 6. Text

Emoce hrají obrovskou roli v tom, **co si zapamatuješ**. Amygdala (centrum emocí) pracuje společně s hippocampem (centrum paměti) — silný emoční zážitek se ukládá mnohem rychleji a hlouběji než neutrální informace.
...
Emotions play a huge role in **what you remember**. The amygdala (emotion center) works together with the hippocampus (memory center) — a strong emotional experience is stored much faster and deeper than neutral information.
...
- ❌ Lidé si silné zážitky víc připomínají, proto je mají v paměti lépe
  Připomínání hraje roli, ale primární příčina je v momentu zážitku: amygdala posiluje stopu při ukládání, ne jen při vybavování.
...
- ❌ People recall strong experiences more often, so they have them in memory better
  Recalling plays a role, but the primary cause is at the moment of the experience: the amygdala strengthens the trace during storage, not just during recall.

### 8. Klíčový poznatek

**Vzpomínky nejsou videozáznamy — jsou to rekonstrukce, které se pokaždé mírně mění.** Emoce posilují paměťové stopy a spánek je konsoliduje. Proto ani ten „nejlepší paměťář" nemá paměť přesnou jako počítač.

#### EN

**Memories aren't video recordings — they're reconstructions that change slightly each time.** Emotions strengthen memory traces and sleep consolidates them. That's why even the "best memorizer" doesn't have memory as precise as a computer.
...
- ❌ Dříve existovala, ale moderní technologie ji ztratili, protože lidé paměť nepoužívají
  To je mýtus. Typ paměti se za staletí nezměnil. Lidé vždy měli rekonstruktivní paměť.
...
- ❌ It used to exist, but modern technology made people lose it because they don't use memory
  That's a myth. The type of memory hasn't changed over centuries. Humans have always had reconstructive memory.
...
- ❌ Pamatuješ si jinou verzi filmu, kterou jsi viděl/a dříve
  Možné, ale nepravděpodobné. Nejběžnější vysvětlení je rekonstruktivní povaha paměti.
...
- ❌ You remember a different version of the movie that you saw earlier
  Possible but unlikely. The most common explanation is the reconstructive nature of memory.

## Lekce 3 — Paměť v praxi
*id: `hf-l-brain-memory-c` · typ: application · xp: 20*
...
Teorii znáš. V této lekci se podíváme, jak **zlepšit svou paměť v každodenním životě** — praktické techniky, mnemotechnické pomůcky a proč většina lidí svou paměť podceňuje.
...
You know the theory. In this lesson we'll look at how to **improve your memory in everyday life** — practical techniques, mnemonic devices, and why most people underestimate their memory.

### 2. Text

Pokud chceš něco skutečně zapamatovat, existuje jednoduchý postup:
...
If you want to actually remember something, there's a simple procedure:
...
- ❌ Pečlivě přepsat poznámky do čistého sešitu
  Opisování je poloaktivní — o něco lepší než čtení, ale mnohem horší než aktivní vybavování. Čas je lépe investovaný do testování se.
...
- ❌ Carefully rewrite notes into a clean notebook
  Copying is semi-active — somewhat better than reading, but much worse than active recall. Time is better invested in testing yourself.

### 4. Text

Druhý mocný nástroj jsou **mnemotechnické pomůcky** — triky, které propojují novou informaci s něčím, co už znáš. Mozek si totiž pamatuje lépe to, co má **kontext, příběh nebo vizuální obraz**.
...
The second powerful tool is **mnemonic devices** — tricks that link new information to something you already know. The brain remembers better things that have **context, a story, or a visual image**.
...
- ❌ Je to jen iluze — memory palace ve skutečnosti nefunguje lépe než opakování
  Studie opakovaně ukazují, že memory palace výrazně překonává prosté opakování. Mistři paměti na soutěžích si pomocí této metody zapamatují stovky číslic v minutách.
...
- ❌ It's just an illusion — memory palace doesn't actually work better than repetition
  Studies repeatedly show that memory palace significantly outperforms simple repetition. Memory champions at competitions memorize hundreds of digits in minutes using this method.

### 6. Text

Třetí praktické pravidlo: **nevěř své paměti slepě**. Vzpomínky jsou rekonstrukce — a proto se mohou mýlit. To je normální, ne vada.
...
Third practical rule: **don't blindly trust your memory**. Memories are reconstructions — and they can be wrong. That's normal, not a defect.
...
- ❌ Máš špatnou paměť, normální mozek to zvládne
  Tohle je normální mozek. I lidé s nadprůměrnou pamětí používají seznamy, kalendáře a poznámky — právě proto, že chápou limity svého systému.
...
- ❌ You have bad memory, a normal brain would handle it
  This is a normal brain. Even people with above-average memory use lists, calendars, and notes — precisely because they understand the limits of their system.

### 8. Klíčový poznatek

**Dobrá paměť není dar — je to systém.** Aktivní vybavování, spaced repetition, mnemotechnické pomůcky a zápis důležitých věcí. Kdo tyto nástroje používá, má „lepší paměť" než ten, kdo spoléhá na holý mozek.

#### EN

**Good memory isn't a gift — it's a system.** Active recall, spaced repetition, mnemonic devices, and writing down important things. Those who use these tools have "better memory" than those who rely on a bare brain.
...
- ❌ Chytří lidé si myslí, že paměť nepotřebují, a proto ji netrénují
  Některých se to týká, ale hlavní příčina je biologická — paměť má své limity bez ohledu na postoj.
...
- ❌ Smart people think they don't need memory, so they don't train it
  That applies to some, but the main cause is biological — memory has its limits regardless of attitude.
...
- ❌ Jíst potraviny bohaté na omega-3, protože tuky živí mozek
  Omega-3 jsou dobré pro zdraví mozku, ale samy o sobě nenahradí techniky učení. Paměť se zlepšuje hlavně tím, jak ji používáš, ne tím, co jíš.
...
- ❌ Eat foods rich in omega-3 because fats feed the brain
  Omega-3 is good for brain health, but on its own it can't replace learning techniques. Memory improves mainly by how you use it, not by what you eat.
