...
Bílkoviny, sacharidy a tuky — tři základní makroživiny, které tělu dodávají energii a stavební materiál.

### EN

Protein, carbohydrates, and fats — the three core macronutrients that supply your body with energy and building blocks.

## Plné vysvětlení

Makroživiny (makra) jsou živiny, které potřebujeme v gramech denně: bílkoviny (4 kcal/g), sacharidy (4 kcal/g) a tuky (9 kcal/g). Bílkoviny stavějí a opravují tkáně, sacharidy jsou primárním palivem pro mozek a svaly, tuky jsou potřebné pro hormony, vstřebávání vitamínů A, D, E, K a buněčné membrány. Žádná z nich není „zlá" — klíčové je poměr a celkové množství vzhledem k cílům.

### EN

Macronutrients (macros) are the nutrients you need in grams every day: protein (4 kcal/g), carbohydrates (4 kcal/g), and fats (9 kcal/g). Protein builds and repairs tissue, carbs are the primary fuel for your brain and muscles, and fats are essential for hormones, absorbing vitamins A, D, E, and K, and building cell membranes. None of them is "evil" — what matters is the ratio and total amount relative to your goals.

## Příklad ze života

Petra si chce zhubnout a začala jíst jen salát. Po týdnu je unavená a hladová. Problém: má 800 kcal denně, 20 g bílkovin, skoro žádné tuky. Když přidá kuřecí prsa, olivový olej a rýži, má 1 600 kcal, 120 g bílkovin, sytí se a zároveň hubne.

### EN

Petra wants to lose weight and has started eating only salad. After a week she's tired and hungry. The problem: 800 kcal a day, 20 g of protein, almost no fat. Once she adds chicken breast, olive oil, and rice, she's at 1,600 kcal and 120 g of protein — she feels full and is still losing weight.

## Časté chyby

Nejčastější chyba je démonizace jedné makroživiny — „sacharidy tloustnou" nebo „tuky ucpávají cévy". Ve skutečnosti tloustneme z nadbytku kalorií, ne z konkrétní makroživiny. Další chyba: přehlížení bílkovin při hubnutí, což vede ke ztrátě svalů místo tuku.

### EN

The most common mistake is demonizing one macronutrient — "carbs make you fat" or "fat clogs your arteries." In reality you gain fat from a calorie surplus, not from a specific macro. Another mistake: ignoring protein while dieting, which leads to losing muscle instead of fat.
