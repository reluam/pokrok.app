...
import type { PublicSong } from "./songsUi";
...
registerSchema({
  ...
  statements: (sql) => [
    ...
    sql`ALTER TABLE songs ADD COLUMN IF NOT EXISTS likes INT NOT NULL DEFAULT 0`,
    sql`CREATE TABLE IF NOT EXISTS song_comments (
