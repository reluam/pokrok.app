...
describe("tetrisLogic", () => {
  it("a piece pushed off the edge in the top quarter vanishes, flags the hidden path and scores 250", () => {
    ...
    expect(s.score).toBe(250); // 250 per piece sent off the field
  });
