...
export const journeyUi = {
  cs: {
    back: "← Spaghetti.ltd",
    title: "Cesta životem",
    intro: "Od první buňky až po poslední dech. Scrolluj a projdi celý lidský život.",
    scrollHint: "Scrolluj ↓",
    of: "z",
  },
  en: {
    back: "← Spaghetti.ltd",
    title: "A Human Life",
    intro: "From the first cell to the last breath. Scroll to travel through an entire human life.",
    scrollHint: "Scroll ↓",
    of: "of",
  },
} as const;
