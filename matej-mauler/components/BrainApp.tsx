...
const T = {
  cs: {
    ...
    legendBall: "kulička = směr převahy asociací",
    ...
    explainP1: "Když jsi psal/a asociace, nejspíš ti naskočilo slovo, které tě napadlo jako úplně první.",
    explainP2: "A jako první tě napadlo proto, že k němu máš nejsilnější neuronové spojení — zjednodušeně řečeno.",
    explainP3: "Podobně roste i síť, kterou jsi právě pomohl/a spoluvytvořit: čím víc lidí spojí dvě slova, tím silnější je mezi nimi synapse.",
    explainGo: "Ukázat moji síť →",
    mineTitle: "Tvé asociace vs. dav",
    mineEmpty: "V téhle návštěvě jsi zatím žádnou asociaci nezapsal/a.",
    minePct: (p: number) => `${p} % ostatních asociací u toho slova mířilo na totéž`,
  ...
  en: {
    ...
    legendBall: "ball = the dominant direction of associations",
    ...
    explainP1: "While associating, you most likely wrote the very first word that popped into your head.",
    explainP2: "It popped up first because you have the strongest neural connection to it — put simply.",
    explainP3: "The network you just helped build grows in a similar way: the more people link two words, the stronger the synapse between them.",
    ...
    minePct: (p: number) => `${p}% of other associations from that word matched yours`,
