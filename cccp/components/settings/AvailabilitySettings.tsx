...
export function AvailabilitySettings() {
  ...
  if (loading) {
    return (
      <p className="text-sm text-slate-500">Načítám dostupnost…</p>
    );
  }
  ...
  return (
    <section className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
      ...
      <p className="mb-4 text-xs text-slate-600">
        Přidej časová okna (den, od–do, délka slotu). Sloty pro veřejnou rezervaci se z nich generují automaticky.
      </p>
      ...
      {windows.length === 0 && (
        <p className="py-2 text-xs text-slate-500">
          Zatím nemáš žádná okna. Klikni na „Přidat okno“ a nastav dny a časy.
        </p>
      )}
