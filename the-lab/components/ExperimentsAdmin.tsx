...
export function ExperimentsAdmin({ initial }: { initial: ExperimentRow[] }) {
  ...
  const [newExp, setNewExp] = useState<Partial<ExperimentRow>>({ color: "#EDE9FE", emoji: "🧪" });
              ...
              {editing === r.slug && (
                <div style={{ marginTop: "10px", paddingTop: "10px", borderTop: "1px solid var(--border)" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                    <input style={{ ...inputS, width: "64px", marginBottom: 0 }} value={draft.emoji ?? ""} onChange={(e) => setDraft({ ...draft, emoji: e.target.value })} placeholder="🧪" />
        ...
        <div style={{ marginTop: "16px" }}>
          {!adding ? (
            ...
            <div style={{ background: "#fff", border: "2px solid var(--border)", borderRadius: "12px", padding: "14px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                <input style={inputS} onChange={(e) => setNewExp({ ...newExp, slug: e.target.value })} placeholder="slug (např. brain)" />
                ...
                <input style={inputS} defaultValue="🧪" onChange={(e) => setNewExp({ ...newExp, emoji: e.target.value })} placeholder="emoji" />
