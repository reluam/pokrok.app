...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/audit-zivota", destination: "/manual/tvuj-kompas", permanent: true },
      { source: "/audit-zivota/:path*", destination: "/manual/tvuj-kompas", permanent: true },
      { source: "/navod-na-zivot", destination: "/muj-kompas", permanent: true },
      { source: "/muj-kompas", destination: "/knihovna", permanent: false },
      { source: "/laborator", destination: "/manual", permanent: true },
      { source: "/laborator/:path*", destination: "/manual/:path*", permanent: true },
      { source: "/dilna", destination: "/manual", permanent: true },
      { source: "/dilna/:path*", destination: "/manual/:path*", permanent: true },
    ];
  },
  async rewrites() {
    return [
