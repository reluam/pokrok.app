...
function FeedContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 pt-28 md:pt-32 pb-16 md:pb-20">
      ...
      {/* Substack CTA */}
      <section className="mt-16 md:mt-24 text-center space-y-5 animate-fade-up" style={{ animationDelay: '200ms' }}>
        ...
        <p className="text-lg text-muted leading-relaxed max-w-2xl mx-auto">
          Pravidelné úvahy, postřehy a věci, které mě napadnou cestou. Bez spamu, bez prodeje &mdash; jen upřímné psaní o tom, jak se snažím žít podle sebe.
        </p>
        <div className="pt-2">
          <a
