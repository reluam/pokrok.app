...
const VALID_TYPES = ["compass", "values", "rituals", "priorities", "areas", "vision", "philosophy", "quarterly", "ikigai", "energy", "beliefs", "relationships", "daily-values", "funeral-speech", "principles"];
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error("GET /api/manual/user-context error:", error);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error("POST /api/manual/user-context error:", error);
