...
export async function POST() {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${siteUrl}/laborator/dashboard?tab=nastrojarna&credits=purchased`,
      cancel_url: `${siteUrl}/laborator/dashboard?tab=nastrojarna`,
      metadata: {
    ...
    console.error("POST /api/laborator/ai-credits/checkout error:", error);
    return NextResponse.json(
