...
- Manuál: interaktivní prostor s cvičeními (Kompas hodnot, Moje hodnoty, Nastav si den) — pro předplatitele
...
- Když je to relevantní, můžeš zmínit, že Manuál nabízí personalizovanou práci na sobě.
