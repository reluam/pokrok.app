      ...
      <section className="pt-10 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <div className="text-center space-y-1 pb-2">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-foreground">Tvůj kompas</h1>
          ...
          {/* Pro koho je */}
          <div className="paper-card rounded-[24px] px-6 py-6 space-y-3">
            <p className="text-xs font-bold uppercase tracking-widest text-foreground/40">Pro koho je Tvůj kompas</p>
            <ul className="space-y-2">
              {[
          ...
          <div className="paper-card rounded-[24px] px-6 py-6 space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-foreground/50">
                Pošleme ti odkaz, díky kterému se ke svému kompasu kdykoliv vrátíš.
              </p>
            </div>
            <input
              type="email"
