    ...
    <section className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
        ...
        <p className="text-lg md:text-xl text-foreground/80 leading-relaxed max-w-2xl mx-auto">
          Jsem ten typ člověka, který má vždy čas na kávu. Pokud se v tom životě taky trochu plácáš, chceš probrat svoje experimenty, nebo jen slyšet jiný úhel pohledu, můžeme dát online kafe a trochu pokecat o životě.
        </p>
