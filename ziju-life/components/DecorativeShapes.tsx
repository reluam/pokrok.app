...
export default function DecorativeShapes({ position = "right", variant = "default" }: DecorativeShapesProps) {
  ...
  return (
    <div className="decorative-shapes absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {isHero && (
        <>
          {/* Top left wave – floating */}
          <div
            className="absolute animate-shape-float"
            style={{ top: "10%", left: "3%", width: "100px", height: "50px" }}
          >
            <svg
          ...
          {/* Top right wave – floating (slower) */}
          <div
            className="absolute animate-shape-float-slow"
            style={{ top: "15%", right: "5%", width: "90px", height: "45px" }}
          >
            <svg
              className="w-full h-full"
          ...
          {/* Middle left wave – floating */}
          <div
            className="absolute animate-shape-float-slow"
            style={{ top: "50%", left: "2%", width: "110px", height: "55px" }}
          >
            <svg
              className="w-full h-full"
