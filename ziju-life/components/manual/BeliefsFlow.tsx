  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={addBelief} className="px-3 py-1.5 rounded-full text-xs font-semibold bg-foreground/5 text-foreground/40 hover:text-accent">
          + Přidat
        </button>
      </div>
      ...
      <div className="bg-white border border-black/8 rounded-[24px] px-5 py-5 space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-foreground/50 uppercase tracking-wider">Oblast</label>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-4 py-3 border border-accent/20 rounded-2xl text-sm bg-accent/[0.02] focus:ring-2 focus:ring-accent/20 focus:border-accent resize-none"
