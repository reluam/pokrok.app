                        ...
                        return (
                          ...
                          >
                            ...
                            {activeGoals.map((goal) => {
                              ...
                              // Simple trend indicator: up arrow if > 50%, down arrow if < 50%
                              const showTrendArrow = progressPercentage !== 50
                              const isPositiveTrend = progressPercentage > 50
                              ...
                              return (
                                <button
                                  ...
                                  title={goal.title}
                                >
                                  <span className="text-xs font-bold flex-shrink-0 min-w-[2.5rem] text-right flex items-center justify-end gap-0.5" style={{ color: areaColor }}>
                                    {showTrendArrow && (
                                      isPositiveTrend ? (
