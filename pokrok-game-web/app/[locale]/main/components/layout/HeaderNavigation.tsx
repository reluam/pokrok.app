            ...
            <div className="flex items-center gap-3 sm:gap-4 lg:gap-6">
              ...
              <div className="hidden lg:flex items-center gap-3">
                <button
                  ...
                  title={t('statistics.steps.title') || 'Dokončené kroky'}
                >
                  <svg className="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                  <span className="text-black font-semibold text-sm">{completedSteps}</span>
                  <span className="text-gray-600 text-xs">{t('statistics.steps.title') || 'Kroky'}</span>
                </button>

                <button
                  onClick={() => setCurrentPage('statistics')}
                  className="box-playful-highlight flex items-center gap-1.5 px-2 py-1 hover:bg-primary-50 transition-colors cursor-pointer"
                  title={t('statistics.habits.title') || 'Dokončené návyky'}
                >
                  <svg className="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                  <span className="text-black font-semibold text-sm">{completedHabits}</span>
                  <span className="text-gray-600 text-xs">{t('statistics.habits.title') || 'Návyky'}</span>
                </button>
