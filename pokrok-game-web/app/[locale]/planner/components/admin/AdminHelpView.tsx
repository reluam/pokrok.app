                ...
                <div className="divide-y divide-primary-100">
                  {sections.map(section => (
                    <div key={section.id} className="p-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs font-semibold text-black mb-1">Title (Czech)</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-black mb-1">Title (English)</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-black mb-1">Content (Czech)</label>
                          <textarea
                            ...
                            className="w-full px-3 py-2 border-2 border-primary-500 rounded-playful-sm min-h-[120px]"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-semibold text-black mb-1">Content (English)</label>
                          <textarea
